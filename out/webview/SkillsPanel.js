...
class SkillsPanel {
    ...
    getHtmlContent(webview) {
        const stylesheetUri = webview.asWebviewUri(vscode.Uri.joinPath(this.extensionUri, 'media', 'dist', 'assets', 'index.css'));
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this.extensionUri, 'media', 'dist', 'assets', 'index.js'));
