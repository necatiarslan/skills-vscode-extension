...
- AI Agent Skills Marketplace (search, inspect, and install skills from skillsmp.com)
...
The Skills Marketplace provides a secondary feature set for discovering and installing AI Agent Skills:
